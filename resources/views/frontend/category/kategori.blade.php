                            ...
                            @foreach($urunler as $urunx)
                                <div class="col-sm-6 col-md-4 mb-4">
                                    <div class="product portfolio-item portfolio-item-style-2">
                                        <div class="image-frame image-frame-style-1 image-frame-effect-2 mb-3">
											<span class="image-frame-wrapper image-frame-wrapper-overlay-bottom image-frame-wrapper-overlay-light image-frame-wrapper-align-end">
												<a href="{{route('urun',$urunx->slug)}}">
													<img style="height: 200px; width: 200px" src="/frontend/uploads/product/{{$urunx->urun_resmi}}" class="img-fluid" alt="">
												</a>
                                        ...
                                        <div class="product-info text-center   flex-column flex-lg-row ">
                                            <div class="product-info-title">
                                                <h3 class="text-color-default text-2 line-height-1 mb-1"><a  href="{{route('urun',$urunx->slug)}}">{{$urunx->urun_adi}}</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
