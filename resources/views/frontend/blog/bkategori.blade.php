...
@section('aside-page-title')
 NEWS ROOM > <span class="text-uppercase">{{$kategori->kategori_adi}}</span>
@endsection

@section('sayfa-title')

    <title>RD Global Research & Development | {{$kategori->kategori_adi}} </title>
                        ...
                        <div class="col-md-8 col-lg-9 order-1 mb-5 mb-md-0">
                            <div class="row  portfolio-list portfolio-list-style-2" data-plugin-masonry data-plugin-options="{'itemSelector': '.isotope-item'}">
                                @if ($blog->isEmpty())
                                        ...
                                        <h2 class="text-color-light-2 text-12 news-there " ><u>THERE İS NO CONTENT.</u></h2>
                                        ...
                                        <div class="portfolio-item">
                                            <article class="blog-post">
                                                        ...
                                                        <a href="{{route('sblog',$bg->slug)}}">
                                                            <div class="image-frame hover-effect-2">
                                                                <div class="image-frame-wrapper">
                                                                    <img src="/frontend/uploads/blog/ongorsel/{{$bg->gimage}}" class="img-fluid" alt="" />
                                                                </div>
                                                            </div>
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="d-flex opacity-6 my-2">
                                                    <span class="top-sub-title text-color-light-2 px-3 text-2"> {{$bg->created_at->toDateString() }}</span>
                                                ...
                                                <p class="text-color-light-2">{{$bg->blog_aciklama}}</p>
