    ...
    <div class="col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
                ...
                <form method="post" action="{{route('admin.blogkategori.guncelle',$kategori->id)}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-12 text-center">
                        {!! Form::text('kategori_adi',$kategori->kategori_adi, ['class' => 'form-control text-center ',  'placeholder' => 'Kategori Başlığını Giriniz', 'required' => '']) !!}
                    </div>
