    ...
    <div class="footer-copyright bg-dark-2">
        <div class="container">
            <div class="row text-center align-items-center">
                ...
                <div class="col-md-12 ">
                    <p class="text-center pb-0 mb-0 text-light ">Copyrights © {{Date('d-m-Y H:i:s')}}. All Rights Reserved <a href="https://www.rdglobal.com.tr/" class="text-light text ">RD GLOBAL</a></p>
                </div>
            </div>
        </div>
    </div>
